...
description: >-
  将人物、空间、产品、建筑、历史、神话、科幻或简单故事，转译为真实电影拍摄感的 21:9 单帧或三联叙事镜头，并可在电影分镜后补充片名命名、带文字主题海报与完整视觉体系封面。重点解决构图缺乏判断、色彩单一阴冷、CG/AI油腻、剧情平常化、电视剧化、海报主题松散和文字封面廉价化等问题。参考图仅用于抽象分析，不参与图像生成。
---
...
当用户要做全 AI 影片、短剧、预告片、故事板、封面、海报、片名或视觉体系时，在分镜之后追加一个 **主题海报与视觉体系封面阶段**：先为影片命名，再把三联分镜中的核心冲突、综合色和视觉符号转译成一张可发布的带文字主视觉封面。
...
当用户要求“短剧海报”“电影封面”“视觉体系”“带文字主题海报”“自动取名”或“完整封面”时，三联分镜通过自检后继续执行：
...
这个阶段用于把三联分镜提升为“影片项目封面”，适合全 AI 影片、短剧、概念预告、分镜合集、系列封面和社媒发布首图。

### 13.5.1 自动命名规则

若用户没有给片名，先自动命名。片名必须来自剧情冲突，而不是来自题材标签。
